...
error_reporting(E_ERROR);
	...
	$arrZamowienia = $objZamowienia->getRegsList(1);
...
<?php
	...
	<div class="main">
	    <div class="dane" id="data<?php echo $aV['id']; ?>">
	        <?php echo $strData; ?>
	        <br />
	        <form name="wplata<?php echo $aV['id'] ?>" method="post" action="confirm_pay.php">
            ...
            <br />
	        <form name="wplata<?php echo $aV['id'] ?>" method="post" action="confirm_sent.php">
	            <input type="hidden" name="id" value="<?php echo $aV['id']; ?>" />
